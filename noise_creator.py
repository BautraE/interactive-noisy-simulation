...
class NoiseCreator:
    ...
    def link_noise_data_manager(self, noise_data_manager: NoiseDataManager):
    ...
    def __add_readout_error(self, qubit_nr, columns):
    ...
    def __add_depolarizing_error(self, qubit_nr, columns):
    ...
    def __add_thermal_error(self, qubit_nr, columns):
