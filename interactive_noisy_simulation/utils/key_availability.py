...
def block_key(key: str, instance_type: str, blocker_key: str) -> None:
    ...
    Args:
        ...
        blocker_key (str): Key of instance that is causing the blocking
            of the current key.
    """
    blocked_keys = key_availability[instance_type]["blocked_keys"]
    blocked_keys[key] = blocker_key

def unblock_key(key: str, instance_type: str) -> None:
...
def check_blocked_key(key: str, instance_type: str) -> None:
    ...
    """
    instance_info = key_availability[instance_type]
    blocked_keys = key_availability[instance_type]["blocked_keys"]
